...
export const DataAboutStartupsSchema = (t: (arg: string) => string) =>
  z.object({
    ...
    stateAndCity: z.string().optional(),
    mainResponsibleName: z.string().optional(),
    mainResponsibleLinkedin: z
      .string()

      .optional(),
    contactNumber: z.string().optional(),
    mainResponsibleEmail: z.string().optional(),
    partnersQuantity: z.coerce.number().optional(),
    partnersPositionRelation: z.string().optional(),
    exclusiveDedicationPartner: z.string().optional(),
    employeesQuantity: z.coerce.number().optional(),
    fullTimeEmployeesQuantity: z.coerce.number().optional(),
    businessModel: z.string().optional(),
    operationalStage: z.string().optional(),
    startupChallenges: z.array(z.string()).optional(),
    isDeepTech: z.string().optional(),
    loadPitchDeck: z.custom<File>((v) => v instanceof File).optional(),
    loadLogo: z.custom<File>((v) => v instanceof File).optional(),
    shortDescription: z.string().optional(),
    valueProposal: z.string().optional(),
  });
...
export const DataServiceProductSchema = (t: (arg: string) => string) =>
  z.object({
    startupProductService: z.array(z.string()).optional(),
    problemThatIsSolved: z.string().optional(),
    competitors: z.string().optional(),
    competitiveDifferentiator: z.string().optional(),
    quantityOdsGoals: z.coerce.number().optional(),
  });

export const DataAboutTeam = (t: (arg: string) => string) =>
  z.object({
    partnersHaveAlreadyBeenInOtherBusiness: z.string().optional(),
    parnertsHaveComplementaryAreaOfActivity: z.string().optional(),
    oneOrMoreDedicationPartner: z.string().optional(),
    oneOrMorePartnersHasProvenExperience: z.string().optional(),
  });

export const DataAboutGovernance = (t: (arg: string) => string) =>
  z.object({
    isStartupOfficiallyRegistered: z.string().optional(),
    isTherePartnersAgreementSigned: z.string().optional(),
    haveLegalAdvice: z.string().optional(),
    haveAccountingConsultancy: z.string().optional(),
    relationshipsRegisteredInContract: z.string().optional(),
  });

export const DataAboutFinanceAndMarket = (t: (arg: string) => string) =>
  z.object({
    customersQuantity: z.coerce.number().optional(),
    lastRevenue: z.coerce.number().optional(),
    lastSixMonthsRevenue: z.coerce.number().optional(),
    lastTwelveMonthsRevenue: z.coerce.number().optional(),
    alreadyRaisedInvestment: z.string().optional(),
